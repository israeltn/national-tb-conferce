          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              {/* <div className="hidden lg:flex items-center">
                  ...
                  <div className="-mb-1">
                     <Link className="github-button no-underline" to="#" data-color-scheme="no-preference: dark; light: light; dark: light;" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star themesberg/windster-tailwind-css-boarddashboard on GitHub">
                         Star
                    </Link>
                  </div>
               </div> */}
            ...
            <div className="flex-1 flex h-full flex-col pt-12 md:pt-8 pb-4 overflow-y-auto">
              ...
              <div className="flex-1 h-full px-3 bg-white">
                <ul className="space-y-2 pb-2">
                  ...
                  {/* <li>
                   <NavLink to="/boarddashboard/users" className="text-base no-underline text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                  ...
                  <li>
                    <NavLink
                      to="/boarddashboard/delegates"
                      className="text-base no-underline text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group "
                    >
                      <svg
                        className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-red-700 transition duration-75"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke-width="1.5"
                  ...
                  <li>
                    <Link
                      to="/boarddashboard/assignedabstracts"
                      className="text-base no-underline text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2"
                    >
                      <svg
                        className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-red-600 transition duration-75"
                  ...
                  <li>
                    <Link
                      to="/boarddashboard/approvedabstract"
                      className="text-base no-underline text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group "
                    >
                      <svg
                        className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-red-600 transition duration-75"
