...
export const Header = () => {
  ...
  return (
     ...
     <img className="h-auto md:w-80 w-60 " src={require('../../assets/StopTBlogo.png')} alt=""/>
     </div>
     <div className="items-center justify-center">
     <img className="h-auto md:w-96 w-60 " src={require('../../assets/NationalTBLogo.jpg')} alt=""/>
     </div> 
     <div className="items-center justify-end">
     <img className="md:w-80 w-60  h-auto " src={require('../../assets/NTLCPLogo.png')} alt=""/>
     </div>
</nav>
...
<div className={`md:flex md:h-12 pt-1  md:max-w-screen-xl mx-auto  relative  md:justify-center md:items-center bg-red-800
          ${
               navbar ? "block" : "hidden"
          }`}>
 ...
 <ul className="md:flex w-[40rem] md:w-auto items-center lg:space-x-4 md:space-x-1.5 text-xs md:text-xs lg:text-sm font-bold">
   ...
   <li className="hover:text-white hover:bg-red-700 py-2 px-2 cursor-pointer  transition-transform duration-300 ease-out rounded-sm ">
    ...
    <NavLink  to="/sponsorship" className={({ isActive }) => {
                  return (
                    'hover:text-white hover:bg-red-700 py-1.5 px-2 ' +
                    (!isActive
                      ? 'cursor-pointer  transition-transform duration-300 ease-out rounded-sm'
   ...
   <li className="relative flex cursor-pointer hover:bg-red-700 z-30 py-2 px-2" onClick={() => setToggle(!toggle)}>
       <button  className="rounded-lg text-white  px-2">
         Past Conferences 
       </button>
       <div className={`absolute ml-28 lg:right-0 z-10 lg:bg-red-800 bg-red-700 lg:w-20 w-14 text-center rounded-lg py-2 mt-1 lg:mt-6 text-white  ${
               toggle ? "block" : "hidden"
          }`}>
