...
export const EditAbstract = ({ abstractId }) => {
    ...
    useEffect(() => {
        const fetchAbstract = async () => {
            try {
                const response = await axios.get(`/api/abstract/${id}`);
    ...
    const handleInputChange = (e) => {
        ...
        setAbstract({ ...abstractInput, [name]: value });
    };
    ...
    const updateAbstract = (e) => {
        ...
        setLoading(true);
         // Login...
         axios.post(`/api/update-abstract/${id}`, formData, config).then(res =>{ 
           ...
           <div className="py-2 px-4 mx-auto max-w-screen-xl text-center lg:pt-4 lg:px-6">
               <h2 className="text-xl uppercase font-bold md:text-4xl">Abstract Submission</h2>
                  ...
                  <div className="container justify-center items-center max-w-screen-xl mx-auto">
                   ...
                   <form onSubmit={updateAbstract} className="w-full  justify-center items-center max-w-screen-xl mx-auto ">
                       ...
                       <div className="flex px-3  flex-wrap w-[10rem] -mx-3 mb-6 justify-center items-center">
                           ...
                           <div className="">
                               <select name="prefex" onChange={handleInputChange} value={abstractInput.prefex} className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-prefex">
                           ...
                           <input type="text" name="surname"  onChange={handleInputChange} value={abstractInput.surname} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name"  />
                           ...
                           <input type="text" name="firstname" onChange={handleInputChange} value={abstractInput.firstname} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name"  />
                       ...
                       <div className="flex flex-wrap -mx-3 mb-6">
                           ...
                           <div className="relative">
                               <select type="text" name="gender" onChange={handleInputChange} value={abstractInput.gender} className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"  id="grid-gender">
                               <option>Select</option>
                       ...
                       {/* <p className="text-red-500 text-xs italic">Please fill out this field.</p> */}
                           ...
                           <input type="tel" name="phone" onChange={handleInputChange} value={abstractInput.phone} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-phone"  />
                       ...
                       <div className="flex flex-wrap -mx-3 mb-6">
                           ...
                           <input type="email" name="email" onChange={handleInputChange} value={abstractInput.email} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" />
                       ...
                       <div className="flex flex-wrap -mx-3 mb-6">
                           ...
                           <input type="text" name="jobtitle" onChange={handleInputChange} value={abstractInput.jobtitle} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name"  />
                           ...
                           <input type="text" name="orgnization" onChange={handleInputChange} value={abstractInput.orgnization} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-orgnization" />
                       ...
                       <div className="flex flex-wrap -mx-3 mb-6">
                           ...
                           <input type="text" name="address" onChange={handleInputChange} value={abstractInput.address} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password"   />
                       ...
                       <div className="flex flex-wrap -mx-3 mb-8">
                           ...
                           <input type="text" name="city" onChange={handleInputChange} value={abstractInput.city} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-city"   />
                           ...
                           <input type="text" name="state" onChange={handleInputChange} value={abstractInput.state} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-city"  />
                           ...
                           <input type="text" name="country" onChange={handleInputChange} value={abstractInput.country} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-zip"   />
                       ...
                       <div className="flex flex-wrap -mx-3 mb-6">
                           ...
                           <div className="w-full  px-3">
                               ...
                               <input type="text" name="abstract_title" onChange={handleInputChange} value={abstractInput.abstract_title} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name"   />
                       ...
                       <div className="flex flex-wrap -mx-3 mb-6">
                           ...
                           <div className="relative">
                               <select name="abstract_thematic" onChange={handleInputChange} value={abstractInput.abstract_thematic} className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                       ...
                       <div className="flex flex-wrap mx-3 mb-6">
                           ...
                           <textarea name="information" onChange={handleInputChange} value={abstractInput.information} id="message" rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
