...
export const UserViewAbstract = (props) => {
  const url= baseURL;
          ...
          <div className="mb-2  justify-center items-center">
            ...
            <div className="flex flex-wrap -mx-3 mt-2 mb-4">
              <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <p className=" w-full uppercase text-sm text-green-600 font-medium  focus:ring-blue-500 focus:border-blue-500     dark:focus:ring-blue-500 dark:focus:border-blue-500">
                  {" "}
