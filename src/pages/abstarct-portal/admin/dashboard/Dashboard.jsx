         ...
         <tr key={i}>       
                                 ...
                                 <td className="px-6 py-4 whitespace-nowrap">
                                    <div className="flex items-center">
                                       ...
                                       <div className="text-sm font-medium text-gray-900">{item.firstname} {item.surname}</div>
            ...
            <div className="pt-6 px-4 bg-gray-100">
               ...
               <div className="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                  <div className="shadow bg-white rounded-lg p-4 sm:p-6 xl:p-8 ">
                     ...
                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-14 h-14 stroke-red-900">
                     <path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" />
                     </svg>


                        <div className="flex-shrink-0">
                           <span className="text-2xl sm:text-3xl leading-none font-bold text-black">2,340</span>
                           <h3 className="text-base font-normal text-gray-400">Total Abstrate Authors </h3>
                        </div>
                  ...
                  <div className="shadow bg-white rounded-lg p-4 sm:p-6 xl:p-8 ">
                     ...
                     <svg class="w-14 h-14 stroke-yellow-400 text-gray-500 flex-shrink-0 group-hover:text-red-600 transition duration-75"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                        </svg>
                        <div className="flex-shrink-0">
                           <span className="text-2xl sm:text-3xl leading-none font-bold text-black">355</span>
                           <h3 className="text-base font-normal text-gray-400"> Total Abstract Submitted</h3>
                        </div>
                  ...
                  <div className="shadow bg-white  rounded-lg p-4 sm:p-6 xl:p-8 ">
                     ...
                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-14 h-14 stroke-violet-600">
                     <path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" />
                     </svg>

                        <div className="flex-shrink-0">
                           <span className="text-2xl sm:text-3xl leading-none font-bold text-black">385</span>
                           <h3 className="text-base font-normal text-gray-400">Total Conference Participants</h3>
                        </div>
               ...
               <div className="flex mx-3 flex-col">
                     <div class="md:flex items-center justify-between mx-4 mt-2">
                              <div className='flex md:justify-start md:items-start text-center'>
                                    <h2 class="text-gray-600 mt-2 my-4 md:text-xl text-sm font-semibold text-center">Latest Participants</h2>
                              </div>                             
                        </div>
               ...
               <div className="bg-white shadow rounded-lg p-4 mt-8 sm:p-6 xl:p-8 ">
                     <h3 className="text-xl leading-none font-bold text-gray-900 mb-10">Absracts Overview</h3>
                                    ...
                                    <div className="flex items-center">
                                       ...
                                       <div className="relative w-full">
                                          <div className="w-full bg-gray-200 rounded-sm h-2">
                                             <div className="bg-cyan-600 h-2 rounded-sm" style={{ width: 300 }}></div>
                                          </div>
                                       </div>
                                    </div>
                                 </td>
                              ...
                              <tr className="text-gray-500">
                                 ...
                                 <td className="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                                    <div className="flex items-center">
                                       ...
                                       <div className="relative w-full">
                                          <div className="w-full bg-gray-200 rounded-sm h-2">
                                             <div className="bg-orange-300 h-2 rounded-sm" style={{ width: 240 }}></div>
                                          </div>
                                       </div>
                                    </div>
                                 </td>
