       ...
       return (
         <tr key={i}>       
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                   ...
                                   <div className="ml-4">
                                   <div className="text-sm   text-gray-500">{item.firstname} {item.surname}</div>
                              ...
                              <td className="px-6 py-4 whitespace-nowrap">
                                 <div
                                       className="px-2 inline-flex text-center text-sm    text-gray-500 rounded-sm  "
                                    >
                                       {item.city}
                                    </div>
                              </td>                               
                                 ...
                                 <td className="px-6 py-4 whitespace-nowrap">
                                 <span
                                       className="px-2 inline-flex text-center text-sm leading-5   text-gray-500 rounded-sm  "
                                    >
                                       {item.jobtitle}
                                    </span>
       ...
       <div className="flex mx-3 mt-2 flex-col">
          <div className="md:flex items-center justify-between mx-4 my-2 sm:mt-2">
                    <div className='flex md:justify-start md:items-start text-center'>
                         <h2 className="text-gray-600 mt-2 lg:mt-8 md:text-xl text-sm font-bold  text-center">Delegates</h2>
                    </div>
